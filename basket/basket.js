window.addEventListener('DOMContentLoaded', () => {
  ...
  function addBookToBasket(book) {
    ...
    deleteImg.src = 'https://nikplay452.github.io/Book-Collection.github.io/img/delete_icon.png';
    deleteImg.alt = '';
  ...
  basketButton.addEventListener('click', () => {
    ...
    if (cardNumber && expirationDate && cvv) {
      ...
      setTimeout(() => {
        window.location.href = 'https://nikplay452.github.io/Book-Collection.github.io/my_books/index.html'; // перенаправить на страницу "Мои книги" через 2 секунды
      }, 2000);
    };
  })
})