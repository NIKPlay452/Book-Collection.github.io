  ...
  document.querySelectorAll('.left_button').forEach((button) => {
    button.addEventListener('click', (event) => {
      ...
      if (lang === 'Английский') {
        ...
        document.querySelector('[data-lang="Английский"] img').src = "/img/left_flag_filled.png";
        document.querySelector('[data-lang="Русский"] img').src = "/img/left_flag.png";
      } else if (lang === 'Русский') {
        filter = (book) => book.id < 30;
        // Обновите URL-адреса изображений, как необходимо
        document.querySelector('[data-lang="Русский"] img').src = "/img/left_flag_filled.png";
        document.querySelector('[data-lang="Английский"] img').src = "/img/left_flag.png";
      }
      fillBookList(filter);
    });
  });
