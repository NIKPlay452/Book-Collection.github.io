  ...
  function generateBookHTML(book) {
    return `
      <li class="catalog2_li">
        <a href="https://nikplay452.github.io/Book-Collection.github.io/purchase/index.html?id=${book.id}">
  ...
  document.querySelectorAll('.left_button').forEach((button) => {
    button.addEventListener('click', (event) => {
      ...
      if (lang === 'Английский') {
        ...
        document.querySelector('.left_button img[src="https://nikplay452.github.io/Book-Collection.github.io/img/left_flag_filled.png"]').src = 'https://nikplay452.github.io/Book-Collection.github.io/img/left_flag.png';
        document.querySelector('.left_button img[src="https://nikplay452.github.io/Book-Collection.github.io/img/left_flag.png"]').src = 'https://nikplay452.github.io/Book-Collection.github.io/img/left_flag_filled.png';
